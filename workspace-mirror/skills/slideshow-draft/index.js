...
Output:`,
    ...
    const draft = {
      ...
      source: null,
      provider_used: scriptResp.providerUsed || null,
      tokens_in: (scriptResp.tokensIn || 0) + (splitResp.tokensIn || 0) + (capResp.tokensIn || 0) + (hashResp.tokensIn || 0),
      tokens_out: (scriptResp.tokensOut || 0) + (splitResp.tokensOut || 0) + (capResp.tokensOut || 0) + (hashResp.tokensOut || 0),
      status: "pending",
      parent_id: null,
    };
